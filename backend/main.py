...
def _generate_png_icon(size: int, filepath: Path):
    ...
    # 画K线柱 (每根: x位置%, 影线底%, 实体底%, 实体顶%, 影线顶%, 方向)
    # 百分比从顶部算起，所以 小% = 靠近顶部(高价), 大% = 靠近底部(低价)
    candles = [
        (0.15, 0.65, 0.55, 0.40, 0.35, "up"),   # 阳线
        (0.28, 0.70, 0.58, 0.35, 0.28, "up"),   # 大阳线
        (0.40, 0.60, 0.50, 0.38, 0.33, "up"),   # 阳线
        (0.52, 0.55, 0.48, 0.36, 0.30, "up"),   # 阳线
        (0.64, 0.72, 0.60, 0.32, 0.22, "up"),   # 大阳线
        (0.76, 0.62, 0.52, 0.39, 0.34, "up"),   # 阳线
    ]
